var questions = [
    ...
    {
      questTitle: "Which of these is not used to loop?",
      choices: ["for", "while", "foreach", "sequence"],
      answer: "sequence"
    },
    {
      questTitle: "Which of the following cannot be done with client-side JavaScript?",
    ...
    {
      questTitle: "Which of the following are capabilities of functions in JavaScript?",
